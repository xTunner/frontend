;; Doesn't work, due to being written against jclouds. Replace with AWS java sdk soon, because this is useful for e.g. backing up the artifacts server.
...
;;         dev (first (filter #(= root-dev (:deviceName %)) devices))]
