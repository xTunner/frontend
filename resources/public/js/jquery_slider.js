...
(function($){
	$.fn.slides = function( option ) {
		...
		return this.each(function(){
			...
			$('.' + option.paginationClass + ' li a', elem ).click(function(){
				...
				if (current != clicked) {
					animate('slider_controls', paginationEffect, clicked);
				}
				return false;
			});
						...
						if (option.crossfade) {
							...
							control.children(':eq('+ prev +')', elem).fadeOut(option.fadeSpeed,function(){
								...
								if (option.autoHeight) {
									...
									// fade in next slide
									function(){
										control.children(':eq('+ next +')', elem).fadeIn(elem.data('slider').fadeSpeed);
									});
								} else {
								// if fixed height
	...
	$.fn.slides.option = {
		...
		container: 'slider_images', // string, Class name for slides container. Default is "slides_container"
		next: 'next', // string, Class name for next button
		prev: 'prev', // string, Class name for previous button
		pagination: true, // boolean, If you're not using pagination you can set to false, but don't have to
		generatePagination: true, // boolean, Auto generate pagination
		paginationClass: 'slider_controls', // string, Class name for pagination
