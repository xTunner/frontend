...
short_title: iOS builds on OS X
...
are pre-installed on the container image. It is recommended to use
[fastlane](https://fastlane.tools/) to build, sign and distribute your
iOS app to beta-testers.
