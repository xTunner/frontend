...
(defn normalize-error-response [default-response url]
  (-> default-response
                           ...
                           (clj-ajax/transform-opts
                            {:format (merge (clj-ajax/json-request-format)
                             ...
                             :error-handler #(binding [frontend.async/*uuid* uuid]
                                               (put! channel [message :failed (normalize-error-response % url)]))
    ...
    (clj-ajax/ajax-request url method
                           (clj-ajax/transform-opts
                            {:format format
                             ...
                             ;; TODO: clean this up
                             :error-handler #(put! channel (normalize-error-response % url))
