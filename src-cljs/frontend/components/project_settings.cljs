             ...
             [:div
              ...
              [:div.help-block
               ...
               [:p "Your best bet, for fine-grained access to more than one repo, is to create what GitHub calls a "
                ...
                ". Give this user exactly the permissions your build requires, and then log into CircleCI as the machine user and associate its user key with your project."]]])]])))))
